...
export default function tajweed(state={}, action) {
    switch (action.type) {
        case ADD_LEVEL:
            return {
                ...state,
        ...
        case DELETE_LEVEL:
            return {
                ...state,
                levels: Object
            .fromEntries(Object.entries(state.levels).filter(e => e[0] !== action.id))
        }
        case DELETE_LESSON:
            return {
                ...state,
                lessons: Object
            .fromEntries(Object.entries(state.lessons).filter(e => e[0] !== action.id))
        }
        default:
            return state
    }
